...
export function generateMarkdownFilesFromSpec(input) {
  ...
  return {
    ...
    "Documentation.md": `# ${spec.projectName} 实时文档\n\n${section("当前项目结构", list(spec.pagesOrModules))}${section("已完成功能", "- 初始文档包已生成")}${section("未完成功能", list(spec.coreFeatures))}${section("已知问题", list(spec.risks))}${section("当前运行方式", "UNCONFIRMED")}${section("测试方式", list(spec.testStrategy))}${section("最近执行记录", "- 由 Codex 长任务启动器 / Codex Long Task Starter 根据 ProjectSpec 初始化")}`,
