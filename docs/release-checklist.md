...
- [ ] Confirm `README.md` is the Chinese default homepage.
- [ ] Confirm `README.en.md` exists for English readers.
- [ ] Confirm `docs/user-guide.zh-CN.md` exists and is suitable for Chinese developers.
